...
public class FirstLevelVision : MonoBehaviour
{
    private GameObject[] objectsWithTag2; // массив объектов с тэгом "2"
    ...
    void Start()
    {
        objectsWithTag2 = GameObject.FindGameObjectsWithTag("2"); // получить все объекты с тэгом "3"
